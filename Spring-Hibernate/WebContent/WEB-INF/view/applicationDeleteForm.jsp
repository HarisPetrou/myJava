...
<title>Form - delete an application with specific id</title>
</head>
<body>
<a href="<c:url value="/logout"/>"class="button logout" style="position: absolute; right: 0;">Logout</a>
	...
	<h3>Delete application form</h3>

	<form:form method="POST" action="${pageContext.request.contextPath}/secretariat/deleteApplication" modelAttribute="application">
		<table>
