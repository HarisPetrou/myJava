...
<title>Form - Delete a user</title>
</head>
<body>
<a href="<c:url value="/logout"/>"class="button logout" style="position: absolute; right: 0;">Logout</a>
	...
	<h3>Welcome, delete a user with specific username</h3>

	<form:form method="POST" action="${pageContext.request.contextPath}/secretariat/deleteUser" modelAttribute="user">
		<table>
